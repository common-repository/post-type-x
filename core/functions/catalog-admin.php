...
class ic_catalog_frontend_admin {
	...
	public function customize_product_page() {
		if ( function_exists( 'is_customize_preview' ) ) {
			...
			echo '<span><a href="' . $url . '">' . __( 'Customize Page Design', 'post-type-x' ) . '</a></span>';
		}
	}
	...
	public function customize_product_listing() {
		if ( function_exists( 'is_customize_preview' ) ) {
			...
			if ( ! empty( $listing_page ) ) {
				...
				echo '<span><a href="' . $url . '">' . __( 'Customize Listing Design', 'post-type-x' ) . '</a></span>';
			}
		}
	}
	...
	public function customize_icons() {
		if ( function_exists( 'is_customize_preview' ) ) {
			...
			if ( ! empty( $listing_page ) ) {
				...
				echo '<span><a href="' . $url . '">' . __( 'Customize Sitewide Icons', 'post-type-x' ) . '</a></span>';
			}
		}
	}
	...
	public function customize_filters_bar() {
		...
		echo '<span><a href="' . $url . '">' . __( 'Customize Filters Bar', 'post-type-x' ) . '</a></span>';
	}
