...
?>
    ...
    <div class="about__section has-1-column">
        <div class="column">
            <h2><?php _e( 'CTA Options', 'post-type-x' ); ?></h2>
            <p>
                <strong><?php _e( "CTA stands for call to action, and it's the part of a webpage that encourages the audience to do something.", 'post-type-x' ) ?></strong>
            </p>
            <p><?php _e( 'The aim of the 3.x releases is to make a variety of CTAs available so your catalog can convert your users to customers.', 'post-type-x' ); ?></p>
            <p><?php _e( 'Until now there are 3 CTAs available: Shopping Cart add to cart, Quote Cart add to cart and an affiliate button.', 'post-type-x' ); ?></p>
            <p><?php printf( __( 'If you have an idea of a great CTA that could be included, please %1$scontact the developers%2$s!', 'post-type-x' ), '<a target="_blank" href="https://implecode.com/support/?support_type=different&cam=welcome&key=idea">', '</a>' ) ?></p>
        </div>
    </div>
    ...
    <div class="about__section has-1-column">
        <div class="column">
            ...
            <p>
                <strong><?php _e( 'The theme integration is continuously being improved to support more themes and page builders.', 'post-type-x' ) ?></strong>
            </p>
            <p><?php _e( 'The aim of the 3.x releases is to make it compatible with 99% of the themes and page builders.', 'post-type-x' ); ?></p>
            <p><?php _e( 'In the current release, the theme integration goal is almost 100% complete.', 'post-type-x' ) ?></p>
            <p><?php printf( __( 'If you still face any theme or page builder integration issues, please report them on the %1$ssupport forum%2$s.', 'post-type-x' ), '<a href="https://wordpress.org/support/plugin/ecommerce-product-catalog/">', '</a>' ) ?></p>
            <p><?php _e( 'Thank you for all your feedback regarding theme integration issues!', 'post-type-x' ); ?></p>
        </div>
    </div>

    <div class="about__section has-1-column">
        <div class="column">
            <h2><?php _e( 'Speed', 'post-type-x' ); ?></h2>
            <p>
                <strong><?php _e( 'Say hello to the fastest catalog experience.', 'post-type-x' ); ?></strong>
            </p>
    ...
    <div class="about__section has-1-column">
        <div class="column">
            <h2><?php _e( 'Usability', 'post-type-x' ); ?></h2>
            <p>
                <strong><?php printf( __( 'In this release, %s is continuously improved in the field of front-end and back-end usability', 'post-type-x' ), IC_CATALOG_PLUGIN_NAME ) ?></strong>
            </p>
            ...
            <p><?php printf( __( 'If you face any configuration issues, please report it on the %1$ssupport forum%2$s.', 'post-type-x' ), '<a href="https://wordpress.org/support/plugin/ecommerce-product-catalog/">', '</a>' ) ?></p>
            <p><?php _e( 'Thanks to your feedback, we can make things easier together!', 'post-type-x' ); ?></p>
        </div>
    </div>
    ...
    <div class="about__section has-2-columns has-accent-background-color is-wider-right">
        <div class="column">
            <h2><?php _e( 'Security, errors, feedback', 'post-type-x' ); ?></h2>
            <p>
                <strong><?php _e( 'Frequent updates guarantee high security. The plugin is continuously being monitored for any security issues.', 'post-type-x' ); ?></strong>
            </p>
    ...
    <div class="about__section has-2-columns has-subtle-background-color">
        ...
        <div class="column">
            ...
            <p><a href="https://wordpress.org/support/plugin/ecommerce-product-catalog/reviews/#new-post"
                  ...
                  target="_blank"><?php _e( 'Add your review', 'post-type-x' ) ?></a></p>
        </div>
    </div>
    ...
    <div class="about__section has-1-column">
        <div class="column">
            <h2><?php _e( 'Documentation & Help', 'post-type-x' ); ?></h2>
            <p><?php _e( 'Now you can search through the catalog settings and docs from your admin dashboard!', 'post-type-x' ); ?></p>
            <p><?php printf( __( 'You can find the search box in the %1$scatalog settings%3$s or %2$shelp tab%3$s.', 'post-type-x' ), '<a target="_blank" href="' . admin_url( 'edit.php?post_type=al_product&page=product-settings.php' ) . '">', '<a target="_blank" href="' . admin_url( 'edit.php?post_type=al_product&page=extensions.php&tab=help' ) . '">', '</a>' ) ?></p>
        </div>
    </div>
