...
?>
    <div class="wrap about__container">
        ...
        <div class="return-to-dashboard">
            <a href="<?php echo admin_url( 'edit.php?post_type=al_product&page=product-settings.php' ) ?>"><?php _e( 'Go to settings', 'post-type-x' ) ?></a>
        </div>
    </div>
<?php
