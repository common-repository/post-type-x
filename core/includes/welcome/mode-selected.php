...
?>
    ...
    <div class="about__section has-2-columns">
        ...
        <div class="column">
            ...
            <p>
                <a href="https://implecode.com/docs/ecommerce-product-catalog/product-catalog-shortcodes/#cam=welcome&key=shortcodes"><?php _e( 'Available Shortcodes', 'post-type-x' ) ?></a>
            </p>
        </div>
    </div>
