...
function register_product_settings_menu() {
	add_submenu_page( 'edit.php?post_type=al_product', __( 'Settings', 'post-type-x' ), __( 'Settings', 'post-type-x' ), apply_filters( 'see_product_settings_cap', 'manage_product_settings' ), basename( __FILE__ ), 'product_settings' );
...
function product_settings() {
    ...
    <div id="implecode_settings" class="wrap">
        <h2><?php _e( 'Settings', 'post-type-x' ) ?> - impleCode <?php echo IC_CATALOG_PLUGIN_NAME ?></h2>
		<?php
...
function doc_helper( $title, $url, $class = null ) {
	$helper = '<div class="doc-helper ' . $class . '"><div class="doc-item">
		<div class="doc-name green-box">' . sprintf(
			__( '%s Settings in Docs', 'post-type-x' ), ic_ucfirst( $title ) ) . '</div>
		<div class="doc-description">' . sprintf(
		          __( 'See %s configuration tips in the impleCode documentation', 'post-type-x' ), $title ) . '.</div>
		<div class="doc-button"><a href="https://implecode.com/docs/ecommerce-product-catalog/' . $url . '/#cam=catalog-docs-box&key=' . $url . '"><input class="doc_button classic-button" type="button" value="' . esc_attr( __( 'See in Docs', 'post-type-x' ) ) . '"></a></div>
		<a title="' . __( 'Click the button to visit impleCode documentation', 'post-type-x' ) . '" href="https://implecode.com/docs/ecommerce-product-catalog/' . $url . '/#cam=catalog-docs-box&key=' . $url . '" class="background-url"></a>
		</div></div>';
	echo $helper;
}
...
function did_know_helper( $name, $desc, $url, $class = null ) {
	$helper = '<div class="doc-helper ' . $class . '"><div class="doc-item">
		<div class="doc-name green-box">' .
	          __( 'Did you know?', 'post-type-x' ) . '</div>
		<div class="doc-description">' . $desc . '.</div>
		<div class="doc-button"><a href="' . $url . '#cam=catalog-know-box&key=' . $name . '"><input class="doc_button classic-button" type="button" value="' . esc_attr( __( 'See Now', 'post-type-x' ) ) . '"></a></div>
		<a title="' . __( 'Click the button to visit impleCode website', 'post-type-x' ) . '" href="' . $url . '#cam=catalog-docs-box&key=' . $name . '" class="background-url"></a>
		</div></div>';
	echo $helper;
}
...
function review_helper() {
	$helper = '<div class="doc-helper review"><div class="doc-item">
		<div class="doc-name green-box">' . __( 'Rate this Plugin!', 'post-type-x' ) . '</div>
		<div class="doc-description">' . sprintf( __( 'Please <a href="%s">rate</a> this plugin and tell us if it works for you or not. It really helps development.', 'post-type-x' ), 'https://wordpress.org/support/view/plugin-reviews/ecommerce-product-catalog#postform' ) . '</div>
		</div></div>';
	echo $helper;
}
...
function main_helper() {
	$helper = '<div class="doc-helper main"><div class="doc-item">
		<div class="doc-name green-box">' . __( 'Need Help?', 'post-type-x' ) . '</div>
...
function ic_bug_report() {
	$helper = '<div class="doc-helper bug-report"><div class="doc-item">
		<div class="doc-name green-box">' .
	          __( 'Do you have a problem?', 'post-type-x' ) . '</div>
		<div class="doc-description">' . __( 'All bug reports and support tickets are tracked on a daily basis.', 'post-type-x' ) . '</div>
			<div class="doc-description">' . sprintf( __( 'Feel free to submit a ticket if you think that you found a bug or you have a problem while using %s.', 'post-type-x' ), IC_CATALOG_PLUGIN_NAME ) . '</div>
		<div class="doc-button"><a href="https://wordpress.org/support/plugin/ecommerce-product-catalog"><input class="doc_button classic-button" type="button" value="' . esc_attr( __( 'Report a Problem', 'post-type-x' ) ) . '"></a></div>
		<a title="' . __( 'Click the button to visit the support forum.', 'post-type-x' ) . '" href="https://wordpress.org/support/plugin/ecommerce-product-catalog" class="background-url"></a>
		</div></div>';
	echo $helper;
}
