...
function ic_catalog_image_sizes_settings() {
    ...
    <table class="form-table">
        <tbody>
        <tr>
            <th scope="row"><?php _e( 'Catalog Single Page Image', 'post-type-x' ) ?></th>
            <td>
                <fieldset>
        ...
        <tr>
            <th scope="row"><?php _e( 'Catalog Category Page Image', 'post-type-x' ) ?></th>
            <td>
                <fieldset>
                    <legend class="screen-reader-text"><span>Large size</span></legend>
        ...
        <tr>
            <th scope="row"><?php _e( 'Modern Grid Image', 'post-type-x' ) ?></th>
            <td>
                <fieldset>
                    <legend class="screen-reader-text"><span>Large size</span></legend>
        ...
        <tr>
            <th scope="row"><?php _e( 'Classic Grid Image', 'post-type-x' ) ?></th>
            <td>
                <fieldset>
                    <legend class="screen-reader-text">
                        <span><?php _e( 'Classic Grid Image', 'post-type-x' ) ?></span></legend>
        ...
        <tr>
            <th scope="row"><?php _e( 'Classic List Image', 'post-type-x' ) ?></th>
            <td>
                <fieldset>
                    <legend class="screen-reader-text">
                        <span><?php _e( 'Classic List Image', 'post-type-x' ) ?></span></legend>
