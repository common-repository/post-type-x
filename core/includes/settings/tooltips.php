        ...
        <script type="text/javascript">
            jQuery(document).ready(function ($) {
                    ...
                    function ic_pointer_buttons(t, selector) {
                        var button1 = jQuery('<a class="close ic-pointer-dismiss" href="#"></a>').text("<?php _e( 'Hide Forever', 'post-type-x' ) ?>");
                        var button2 = jQuery('<a class="button-primary" href="#"></a>').text("<?php _e( 'Next', 'post-type-x' ) ?>");
                        var wrapper = jQuery('<div class=\"wc-pointer-buttons\" />');
                        button1.on('click.pointer', function (e) {
                            e.preventDefault();
                            //if (confirm("<?php _e( 'Are you sure? This will disable all tutorial boxes on all screens.', 'post-type-x' ) ?>") == true) {
