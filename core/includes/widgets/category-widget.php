...
class product_cat_widget extends WP_Widget {
	...
	function form( $instance ) {
		...
		if ( get_integration_type() != 'simple' ) {
            ...
            <label
                    for="<?php echo $this->get_field_id( 'dropdown' ); ?>"><?php _e( 'Display as dropdown', 'post-type-x' ); ?></label>
            <br/>
            ...
            <label
                    for="<?php echo $this->get_field_id( 'count' ); ?>"><?php _e( 'Show product counts', 'post-type-x' ); ?></label>
            <br/>
