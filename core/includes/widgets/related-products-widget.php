...
class related_products_widget extends WP_Widget {
	...
	function form( $instance ) {
		if ( get_integration_type() != 'simple' ) {
			...
			//implecode_warning( sprintf( __( '%s is disabled due to a lack of main catalog listing.%s', 'post-type-x' ), __( 'Related products widget', 'post-type-x' ), ic_catalog_notices::create_listing_page_button() ) );
